...
Main.update = function() {
	if(Main.zoom && Main.lastZoom != Main.zoom && Main.camera.zoom < 2.0) {
		Main.camera.zoom += 0.1;
	}
	if(Main.unZoom && Main.lastUnZoom != Main.unZoom && Main.camera.zoom > 0.2) {
		Main.camera.zoom -= 0.1;
	}
	if(Main.playerMove.x != 0) {
		Main.objects[0].position.x += Main.playerMove.x;
	}
	if(Main.playerMove.y != 0) {
		Main.objects[0].position.y += Main.playerMove.y;
	}
	Main.camera.lookAt(Main.objects[0].get_center());
	Main.lastZoom = Main.zoom;
	Main.lastUnZoom = Main.unZoom;
};
Main.render = function(frames) {
	var fb = frames[0];
	var g2 = fb.get_g2();
	if(g2.get_font() == null) {
		g2.set_font(kha_Assets.fonts.font_default);
	}
	g2.set_fontSize(20);
	g2.begin(true,kha_Color.fromBytes(0,95,106));
	var text = "Zoom level is: " + Main.camera.zoom;
	g2.drawString(text,kha_System.windowWidth() - 300,0);
	var trans = Main.camera.getTransformation(1.0);
	...
	var _g = 0;
	var _g1 = Main.objects;
	while(_g < _g1.length) {
		var obj = _g1[_g];
		++_g;
		var pos = Main.camera.worldToScreen(obj.position);
...
Main.main = function() {
	kha_System.start(new kha_SystemOptions("Project",1024,768,null,null),function(_) {
		kha_Assets.loadEverything(function() {
			Main.objects.push(new test_Sprite());
			Main.objects.push(new test_Sprite());
			Main.objects[1].position = new kha_math_Vector2(100,100);
			Main.objects.push(new test_Object(100,100));
			Main.objects[2].width *= 2;
			Main.objects[2].height *= 2;
			Main.objects[2].position = new kha_math_Vector2(500,500);
			Main.objects[2].color = -16711936;
			Main.camera = new test_Camera(kha_System.windowWidth(),kha_System.windowHeight());
			...
			kha_input_Keyboard.get(0).notify(Main.down,Main.up);
		});
	});
};
Math.__name__ = true;
...
var kha__$Assets_ImageList = function() {
	this.names = ["bird"];
	this.birdDescription = { name : "bird", original_height : 256, file_sizes : [48918], original_width : 256, files : ["bird.png"], type : "image"};
	this.birdName = "bird";
	this.bird = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,birdLoad: function(done,failure) {
		...
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "birdLoad"});
	}
	,birdUnload: function() {
		this.bird.unload();
		this.bird = null;
...
var test_Object = function(width,height) {
	this.color = -65536;
	this.parallax = 1.0;
	this.rotation = 0.0;
...
$hxClasses["test.Object"] = test_Object;
test_Object.__name__ = true;
test_Object.prototype = {
	position: null
	,rotation: null
	,parallax: null
	,width: null
	,height: null
	,get_center: function() {
		return new kha_math_Vector2(this.position.x + 0.5 * this.width,this.position.y + 0.5 * this.height);
	}
	,color: null
	,render: function(g) {
	...
	,__class__: test_Object
};
var test_Camera = function(width,height) {
	this.lastParallax = 1.0;
	this.zoom = 1.0;
	this.offsetY = 25;
	this.offsetX = 15;
	this.origin = new kha_math_Vector2();
	test_Object.call(this,width,height);
};
$hxClasses["test.Camera"] = test_Camera;
test_Camera.__name__ = true;
test_Camera.__super__ = test_Object;
test_Camera.prototype = $extend(test_Object.prototype,{
	origin: null
	,get_origin: function() {
	...
	,getTransformation: function(parallax) {
		...
		var _this__00 = 1;
		var _this__10 = 0;
		var _this__20 = -this.position.x * parallax;
		var _this__01 = 0;
		var _this__11 = 1;
		var _this__21 = -this.position.y * parallax;
		var _this__02 = 0;
		var _this__12 = 0;
		var _this__22 = 1;
		var m__00 = 1;
		...
		var m__12 = 0;
		var m__22 = 1;
		translation = new kha_math_FastMatrix3(translation._00 * m__00 + translation._10 * m__01 + translation._20 * m__02,translation._00 * m__10 + translation._10 * m__11 + translation._20 * m__12,translation._00 * m__20 + translation._10 * m__21 + translation._20 * m__22,translation._01 * m__00 + translation._11 * m__01 + translation._21 * m__02,translation._01 * m__10 + translation._11 * m__11 + translation._21 * m__12,translation._01 * m__20 + translation._11 * m__21 + translation._21 * m__22,translation._02 * m__00 + translation._12 * m__01 + translation._22 * m__02,translation._02 * m__10 + translation._12 * m__11 + translation._22 * m__12,translation._02 * m__20 + translation._12 * m__21 + translation._22 * m__22);
		...
		var _this__12 = 0;
		var _this__22 = 1;
		var m__00 = _this__00 * translation._00 + _this__10 * translation._01 + _this__20 * translation._02;
		var m__10 = _this__00 * translation._10 + _this__10 * translation._11 + _this__20 * translation._12;
		var m__20 = _this__00 * translation._20 + _this__10 * translation._21 + _this__20 * translation._22;
		var m__01 = _this__01 * translation._00 + _this__11 * translation._01 + _this__21 * translation._02;
		var m__11 = _this__01 * translation._10 + _this__11 * translation._11 + _this__21 * translation._12;
		var m__21 = _this__01 * translation._20 + _this__11 * translation._21 + _this__21 * translation._22;
		var m__02 = _this__02 * translation._00 + _this__12 * translation._01 + _this__22 * translation._02;
		var m__12 = _this__02 * translation._10 + _this__12 * translation._11 + _this__22 * translation._12;
		var m__22 = _this__02 * translation._20 + _this__12 * translation._21 + _this__22 * translation._22;
		translation._00 = m__00;
		translation._10 = m__10;
		translation._20 = m__20;
		translation._01 = m__01;
		translation._11 = m__11;
		translation._21 = m__21;
		translation._02 = m__02;
		translation._12 = m__12;
		translation._22 = m__22;
		var m__00 = 1;
		var m__10 = 0;
		var m__20 = center.x;
		var m__01 = 0;
		...
		var m__12 = 0;
		var m__22 = 1;
		return new kha_math_FastMatrix3(translation._00 * m__00 + translation._10 * m__01 + translation._20 * m__02,translation._00 * m__10 + translation._10 * m__11 + translation._20 * m__12,translation._00 * m__20 + translation._10 * m__21 + translation._20 * m__22,translation._01 * m__00 + translation._11 * m__01 + translation._21 * m__02,translation._01 * m__10 + translation._11 * m__11 + translation._21 * m__12,translation._01 * m__20 + translation._11 * m__21 + translation._21 * m__22,translation._02 * m__00 + translation._12 * m__01 + translation._22 * m__02,translation._02 * m__10 + translation._12 * m__11 + translation._22 * m__12,translation._02 * m__20 + translation._12 * m__21 + translation._22 * m__22);
	}
	...
	,worldToScreen: function(worldPosition) {
		var _this = this.getTransformation(this.lastParallax);
	...
	,__class__: test_Camera
});
var test_Sprite = function() {
	this.flip = new kha_math_Vector2();
	test_Object.call(this,100,100);
	this.image = kha_Assets.images.bird;
	this.width = this.image.get_width();
	this.height = this.image.get_height();
};
$hxClasses["test.Sprite"] = test_Sprite;
test_Sprite.__name__ = true;
test_Sprite.__super__ = test_Object;
test_Sprite.prototype = $extend(test_Object.prototype,{
	image: null
	,flip: null
	,render: function(g) {
		var w = this.width;
		var h = this.height;
		g.set_color(-1);
		g.drawScaledSubImage(this.image,0,0,w,h,this.flip.x > 0.0 ? w : 0,this.flip.y > 0.0 ? h : 0,this.flip.x > 0.0 ? -w : w,this.flip.y > 0.0 ? -h : h);
	}
	,__class__: test_Sprite
});
...
Main.unZoom = false;
Main.zoom = false;
Main.playerMove = new kha_math_Vector2();
Main.lastZoom = true;
Main.lastUnZoom = true;
